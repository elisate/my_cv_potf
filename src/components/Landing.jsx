        ...
        <section className="land2" id="about">
          ...
          <div className="img-text">
            ...
            <div className="img-text1">
              ...
              <a
                href="Elisa_resume.pdf"
                download="Elisa_resume.pdf"
                className="b"
              >
          ...
          <div className="card-service">
            <div className="card1-serv">
              ...
              <div className="text-head2">
                ...
                services. From custom designs to seamless functionality, we
                bring your vision to life. Let us help you stand out online
              </div>
            </div>
            <div className="card1-serv">
              <div className="card1-a1">
          ...
          <div className="project-holder">
            <div className="page-card-holder">
              ...
              <div className="pages-text1">
                Revolutionize the way you handle legal cases! Our innovative
                legal tech project enables seamless online case submissions,
            ...
            <div className="page-card-holder">
              ...
              <div className="pages-text1">
                ...
                simplifies tour booking online, offering a seamless experience
                for users.
              </div>
            ...
            <div className="page-card-holder">
              ...
              <div className="read-text1">
                <div>
                  <a
                    href="https://elisa-cart.vercel.app/"
                    className="readhover"
                  >
                    Read more{" "}
                  </a>
